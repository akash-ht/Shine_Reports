...
def main():
	...
	sql='/data/Analytics/Utils/FinanceReports/Model/SQL/sap_upload.sql'
	report='/data/Analytics/Utils/FinanceReports/Output/SAP_Upload_Inception_To_Date_'+str(previousDate)+'.csv'
	generateReport(sql, report)
	uploadDir="/data1/apacheRoot/html/shine/ReportArchieve/SAP_Upload/"+previousDate.strftime("%b-%Y")
